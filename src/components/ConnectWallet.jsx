      ...
      <div className="container max-w-xl py-12 mx-auto">
        ...
        <div className="flex w-full justify-center">
          <button
            ...
            className="flex-shrink-0 flex text-cadet border-blue-800 border py-2 px-4 focus:outline-none rounded text-lg mt-10 sm:mt-0 mr-2"
          >
            <Coinbase className="w-6" />
          </button>
          <button
            onClick={handleAuthenticate}
            className="flex-shrink-0 flex text-cadet border-gold border py-2 px-4 focus:outline-none rounded text-lg mt-10 sm:mt-0 mx-2"
          >
            <Metamask className="w-[22px] self-center" />
          </button>
          <button
            onClick={handleUAuthenticate}
            className="flex-shrink-0 flex text-cadet border-blue-800 border py-2 px-4 focus:outline-none rounded text-lg mt-10 sm:mt-0 ml-2"
          >
